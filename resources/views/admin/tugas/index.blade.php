            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('tugasEdit', $data->id) }}" class="btn btn-warning btn-sm mx-1" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button data-toggle="modal" data-target="#exampleModal{{$data->id}}" class="btn btn-danger btn-sm mx-1" title="Hapus">
