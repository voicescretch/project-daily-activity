    ...
    <div class="card-body">
        <form action="{{ route('tugasUpdate', $tugas->id) }}" method="POST">
            ...
            <div class="col-xl-12 position-relative mb-2 px-0">
                ...
                <input type="text" id="searchUser" autocomplete="off" class="form-control" value="{{ $tugas->user->nama }}">

                <input type="hidden" name="user_id" id="selectedUserId" value="{{ $tugas->user_id }}">
            ...
            <div class="col-xl-12 mb-2 px-0">
                ...
                <textarea name="tugas" id="inputTugas" class="form-control @error('tugas') is-invalid @enderror">{{ old('tugas', $tugas->tugas)  }}</textarea>
                @error('tugas')
                <div>
                    <small class="text-danger">{{ $message }}</small>
                </div>
            ...
            <div class="col-12 mb-2 px-0">
                ...
                <input type="date" id="tanggal_mulai" name="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror" value="{{ old('tanggal_mulai', $tugas->tanggal_mulai) }}">
                @error('tanggal_mulai')
                <div>
                    <small class="text-danger">{{ $message }}</small>
                </div>
